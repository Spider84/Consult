...
public class UsbSerialProber {
    ...
    public static com.hoho.android.usbserial.driver.ProbeTable getDefaultProbeTable() {
        final ProbeTable probeTable = new com.hoho.android.usbserial.driver.ProbeTable();
        probeTable.addDriver(CdcAcmSerialDriver.class);
        probeTable.addDriver(com.hoho.android.usbserial.driver.Cp21xxSerialDriver.class);
        probeTable.addDriver(FtdiSerialDriver.class);
        probeTable.addDriver(com.hoho.android.usbserial.driver.ProlificSerialDriver.class);
        return probeTable;
    }
