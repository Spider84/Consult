...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    protected final static boolean DEFAULT_VERTICAL = false;
    ...
    public BaseRoundCornerProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            backgroundHeight = DEFAULT_BACKGROUND_WIDTH;
    ...
    protected void setup(Context context, AttributeSet attrs) {
        ...
        maxHeight = (int) typedArray.getDimension(R.styleable.RoundCornerProgress_rcMaxHeight, DEFAULT_PROGRESS_PADDING);

        isVertical = typedArray.getBoolean(R.styleable.RoundCornerProgress_rcVertical, DEFAULT_VERTICAL);
        ...
        layoutProgress.setOrientation((isVertical)?LinearLayout.VERTICAL:LinearLayout.HORIZONTAL);
        layoutSecondaryProgress.setOrientation((isVertical)?LinearLayout.VERTICAL:LinearLayout.HORIZONTAL);
        layoutBackground.setOrientation((isVertical)?LinearLayout.VERTICAL:LinearLayout.HORIZONTAL);
    ...
    protected abstract void setBackgroundLayoutSize(LinearLayout layoutBackground, int width, int height);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setBackgroundLayoutSize(layoutBackground, MeasureSpec.getSize(widthMeasureSpec),Math.min(maxHeight,MeasureSpec.getSize(heightMeasureSpec)));
        onLayoutMeasured();
    ...
    public void setProgress(float progress) {
        ...
        if(isScreenMeasure) {
            ...
            if (isVertical) {
                int progressHeight = (int) setLayoutProgressHeight(ratio);
    ...
    protected abstract float setLayoutProgressHeight(float ratio);
    ...
    public void setBackgroundHeight(int backgroundHeight) { this.backgroundHeight = backgroundHeight; }
    ...
    private void invalidateProgressLayout() {
        if (((!isVertical) && (this.getLayoutParams().width == ViewGroup.LayoutParams.MATCH_PARENT
                || this.getLayoutParams().width == ViewGroup.LayoutParams.WRAP_CONTENT)) ||
           ((isVertical) && (this.getLayoutParams().height == ViewGroup.LayoutParams.MATCH_PARENT
            ...
            backgroudParam.height = ViewGroup.LayoutParams.MATCH_PARENT;
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte((byte) (this.isVertical ? 1 : 0));
        }
